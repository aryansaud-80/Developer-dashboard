  ...
  return (
    <>
      <button
        ...
        className='fixed top-4 left-2 z-50 p-2 rounded-md bg-slate-100 shadow-md lg:hidden'
      ...
      <aside
        id='sidebar'
        className={`fixed top-0 left-0 h-screen bg-slate-100 shadow-sm border-r border-gray-200 w-64 p-6 pt-10 transform transition-transform duration-300 ease-in-out z-50 md:translate-x-0 ${
